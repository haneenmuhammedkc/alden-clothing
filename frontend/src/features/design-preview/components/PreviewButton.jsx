...
/**
 * PreviewButton.jsx
 * Reusable CTA buttons strictly adhering to DESIGN.md Section 6.2
 * Colors: Cocoa Brown (#8B634B), Deep Espresso (#30251F), Warm Beige (#D8C4B4).
 * Radius: 8px (rounded-md). Height: 44px–48px.
 */
export const PreviewButton = ({
  ...
  const baseStyles = "inline-flex items-center justify-center font-sans font-semibold uppercase tracking-wider transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B634B] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed rounded-[8px]";
